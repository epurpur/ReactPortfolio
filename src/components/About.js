    ...
    return (
        <div id='About'> 
            <section id="AboutMeContainer">
                ...
                <br></br>
                <p>I grew up in Boone, North Carolina. In my free time I love to be outside, especially rock climbing or skiing. I also like learning foreign languages, personal finance, yoga, cooking, and home improvement projects.</p>
                </div>
            </section>
        </div>
    )
